...
TEST_F(BlockDropTest, LowerBlockOneRow)
{
    ...
    const auto simulationResult = BlockMovementManager::simulateMove(*jBlock, Direction::DOWN, placedSquares);
    BlockMovementManager::applyResult(*jBlock, simulationResult);
...
TEST_F(BlockDropTest, DropBlock)
{
    ...
    const auto simulationResult = BlockMovementManager::simulateHardDrop(*jBlock, placedSquares);
    BlockMovementManager::applyResult(*jBlock, simulationResult);
